...
//          if postBool {
    ...
    static func uploadDriverDocumentImageWithAlamofire(parameters : Dictionary<String, Any>?, imageArray: [Data], imageArray1: [Data], imageArray2: [Data], imageArray3: [Data],completionBlock : @escaping CompletionBlock)  {

   // static func uploadProfileImageWithAlamofire(parameters : Dictionary<String, Any>?,postBool: Bool(), imageArray: [Data],completionBlock : @escaping CompletionBlock)  {
//          if postBool {
                   //let url = Apphelper.Constants.API.update_profile_photo
        //      }else{
                   let url = Apphelper.Constants.API.updateDriverDocument
        //      }
            let hders : HTTPHeaders = [ "Authorization" : Facade.shared.authToken ?? ""]
            //
            AF.session.configuration.timeoutIntervalForResource = 3600
            ...
            AF.upload(multipartFormData: { (multipartFormData) in
                ...
                for imgData in imageArray{
                 ...
                 //   multipartFormData.append(imgData, withName: "profile_pic", fileName: "\(Date().timeIntervalSince1970).jpeg", mimeType: "image/jpeg")  //jpeg
                      multipartFormData.append(imgData, withName: "driving_licence", fileName: "imageData.jpeg", mimeType:  "image/jpeg")
                    
                }
                for imgData1 in imageArray1{
                    print("File size before compression: \(Double((imgData1.count) / 1048576)) mb")
                    
                    multipartFormData.append(imgData1, withName: "vehicle_insurance", fileName: "imageData.jpeg", mimeType:  "image/jpeg")
                    
                }
                for imgData2 in imageArray2{
                    print("File size before compression: \(Double((imgData2.count) / 1048576)) mb")
                    
                    multipartFormData.append(imgData2, withName: "credential", fileName: "imageData.jpeg", mimeType:  "image/jpeg")
                }
                for imgData3 in imageArray3{
                    print("File size before compression: \(Double((imgData3.count) / 1048576)) mb")
                          
                    multipartFormData.append(imgData3, withName: "qualification", fileName: "imageData.jpeg", mimeType:  "image/jpeg")
                }
    ...
    static func uploadDocumentImageWithAlamofire(parameters : Dictionary<String, Any>?, imageArray: [Data], imageArray1: [Data], imageArray2: [Data], imageArray3: [Data],completionBlock : @escaping CompletionBlock)  {

   // static func uploadProfileImageWithAlamofire(parameters : Dictionary<String, Any>?,postBool: Bool(), imageArray: [Data],completionBlock : @escaping CompletionBlock)  {
//          if postBool {
                   //let url = Apphelper.Constants.API.update_profile_photo
        //      }else{
                   let url = Apphelper.Constants.API.addDriverDocument
        //      }
            let hders : HTTPHeaders = [ "Authorization" : Facade.shared.authToken ?? ""]
            //
            AF.session.configuration.timeoutIntervalForResource = 3600
