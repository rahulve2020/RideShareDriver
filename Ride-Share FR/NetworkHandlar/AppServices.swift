...
func resetPassword(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
    ...
    func profileDetails(param : Dictionary<String, Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.getProfile, parameters: param, requestName: "") { (json, error) in
    ...
    func getCategoryList( success : @escaping successBlock, failure : @escaping failureBlock)  {
        addLoadIndicator()
        
        ServicesClass_New.getDataFromURlWith(url: Apphelper.Constants.API.getCategory, parameters: nil) { (json, error) in
    ...
    func vechileDetails(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.vechicleDetails , parameters: param, requestName: "") { (json, error) in
            ActivityIndicator.hide()
    ...
    func driverUpdateDetails(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.vechicleUpdateDetails , parameters: param, requestName: "") { (json, error) in
            ActivityIndicator.hide()
    ...
    func getSubCategoryList(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.getSubCategory , parameters: param, requestName: "") { (json, error) in
            ActivityIndicator.hide()
    ...
    func getDriverDocument(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.getDocument , parameters: param, requestName: "") { (json, error) in
            ActivityIndicator.hide()
...
//    
    ...
    func addDocument(param : Dictionary<String, Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.addDriverDocument, parameters: param, requestName: "") { (json, error) in
    ...
    func updateDocument(param : Dictionary<String, Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.updateDriverDocument, parameters: param, requestName: "") { (json, error) in
    ...
    func getShareData( success : @escaping successBlock, failure : @escaping failureBlock)  {
        addLoadIndicator()
        
        ServicesClass_New.getDataFromURlWith(url: Apphelper.Constants.API.sharePost, parameters: nil) { (json, error) in
    ...
    func getAddBankDetails(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.addBankDetails , parameters: param, requestName: "") { (json, error) in
            ActivityIndicator.hide()
...
func ignorBookingDetails(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
    ActivityIndicator.show()
    ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.ignorBooking , parameters: param, requestName: "") { (json, error) in
    ...
    func updateOnlineStatus(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.onlineDriverStatus , parameters: param, requestName: "") { (json, error) in
    ...
    func userOTP(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.userOtpVerify , parameters: param, requestName: "") { (json, error) in
    ...
    func startRideUpdate(param : Dictionary<String,Any>, success : @escaping successBlock, failure : @escaping failureBlock)  {
        ActivityIndicator.show()
        ServicesClass_New.postDataFromURL(url: Apphelper.Constants.API.orderStartRide , parameters: param, requestName: "") { (json, error) in
...
//    
    ...
    func driverDocumentImage(param : Dictionary<String,Any>,imageArray : [Data],imageArray1 : [Data],imageArray2 : [Data],imageArray3 : [Data], success : @escaping successBlock, failure : @escaping failureBlock) {
        ActivityIndicator.show()
        
        ServicesClass_New.uploadDocumentImageWithAlamofire(parameters: param, imageArray: imageArray,imageArray1: imageArray1,imageArray2: imageArray2,imageArray3: imageArray3) { (json, error) in
            ActivityIndicator.hide()
            if error == nil
            {
                if self.isSuccess(info: json ?? Dictionary()) {
    ...
    func updateDriverDocumentImage(param : Dictionary<String,Any>,imageArray : [Data],imageArray1 : [Data],imageArray2 : [Data],imageArray3 : [Data], success : @escaping successBlock, failure : @escaping failureBlock) {
        ActivityIndicator.show()
        
        ServicesClass_New.uploadDriverDocumentImageWithAlamofire(parameters: param, imageArray: imageArray,imageArray1: imageArray1,imageArray2: imageArray2,imageArray3: imageArray3) { (json, error) in
            ActivityIndicator.hide()
            if error == nil
            {
                if self.isSuccess(info: json ?? Dictionary()) {
