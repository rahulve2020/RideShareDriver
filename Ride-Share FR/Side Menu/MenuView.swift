...
class MenuView: UIView, UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate {
    ...
    override func didMoveToSuperview() {
        arrayMenu.append(arrMenu.init(name: "Home", icon: "home_on_ic", isSelected: false))
        arrayMenu.append(arrMenu.init(name: "Share", icon: "share_off_ic", isSelected: false))
        arrayMenu.append(arrMenu.init(name: "My Booking", icon: "booking_off_ic", isSelected: false))
        arrayMenu.append(arrMenu.init(name: "Help and Support", icon: "help_off_ic", isSelected: false))
        arrayMenu.append(arrMenu.init(name: "About", icon: "about_off_ic", isSelected: false))
        arrayMenu.append(arrMenu.init(name: "Term and Condition", icon: "term_off_ic", isSelected: false))
        arrayMenu.append(arrMenu.init(name: "Change Password", icon: "lock_off_ic", isSelected: false))
        arrayMenu.append(arrMenu.init(name: "rate Us", icon: "star_2_off)ic", isSelected: false))
